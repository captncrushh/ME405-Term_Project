...
+ ***Main*** <br/>
Before running the tasks, the main code prompts the user to help calibrate the Romi before starting. This includes white and black surface calibration for the line sensor as well as imu calibration and calibration of reference heading angles at checkpoint 4 and for checkpoint 5. <br/> <br/>
+ ***Task Diagram*** <br/>
